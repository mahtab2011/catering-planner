  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (currentUser) => {
      ...
      try {
        ...
        console.error("Orders page access check failed:", error);
        setAllowed(false);
        setGuestView(true);
        setCheckingAccess(false);
        setLoading(false);
      ...
      <main className="min-h-screen bg-linear-to-b from-sky-50 via-white to-white">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-sky-100 bg-white p-8 shadow-sm">
            ...
            <h1 className="mt-5 text-4xl font-extrabold tracking-tight text-neutral-900">
              Order food as a guest or sign in to stay connected
            </h1>

            <p className="mt-4 max-w-3xl text-lg text-neutral-600">
              You can place your order right now as a guest user. If you already
              have an account, sign in to stay connected with your orders,
              faster checkout, saved details, and future food offers and
              updates.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/login"
                className="inline-flex rounded-xl border border-sky-300 bg-sky-50 px-6 py-3 text-sm font-bold text-sky-800 transition hover:bg-sky-100"
              >
                Customer Sign In
              </Link>
              ...
              <Link
                ...
                className="inline-flex rounded-xl border border-emerald-300 bg-emerald-50 px-6 py-3 text-sm font-bold text-emerald-800 transition hover:bg-emerald-100"
              >
              ...
              <Link
                href="/login"
                className="inline-flex rounded-xl border border-neutral-300 bg-white px-6 py-3 text-sm font-bold text-neutral-800 transition hover:bg-neutral-50"
              >
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-sky-100 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-neutral-600">
                Customers can place food orders immediately without creating an
                account.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-neutral-600">
                Existing customers can sign in for easier repeat orders, saved
                details, and future food offers and updates.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
              <div className="text-3xl">🏪</div>
              <div className="mt-3 text-lg font-bold text-neutral-900">
                Restaurant Board Protected
              </div>
              <p className="mt-2 text-sm text-neutral-600">
                Restaurant and staff live order board remains protected behind
                login.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 shadow-sm">
            Note: this page is public for customers and guest users. The live
            order board below remains visible only to restaurant or staff
            accounts.
          </div>
        </div>
      </main>
  ...
  return (
    <div className="mx-auto w-full max-w-7xl p-6">
      ...
      <div className="mt-6 rounded-2xl border border-sky-100 bg-sky-50 p-4 text-xs text-sky-800">
        Security note: this page is protected by login + role check for
        restaurant/staff board access, and it loads only orders where{" "}
