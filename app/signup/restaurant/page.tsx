...
export default function RestaurantSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!cleanEmail) {
      showError("Email address is required for restaurant onboarding.");
      return;
    }
    ...
    if (!form.consent) {
      showError(
        "Please confirm that SmartServeUK may contact you about onboarding."
      );
      return;
    }
